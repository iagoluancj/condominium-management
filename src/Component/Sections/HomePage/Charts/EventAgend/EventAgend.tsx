...
// Oque será preciso: Com base no horário brasilia, deve mostrar oque aconteceu 2h antes e oque acontecerá em 4h. 
const timeSlots = [
...
const events: Event[] = [
    // Quando pegar os dados do banco, lembrar de deixar eles ordenados, dessa forma 
    // não terá problemas ordem errada na visualização. 
    ...
    { title: "Ana Vaz", startTime: "16:20", endTime: "10:30", position: 'end', color: '#FFBF08' },
